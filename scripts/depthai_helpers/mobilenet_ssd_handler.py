...
def show_mobilenet_ssd(entries_prev, frame, **kwargs):
    ...
    for e in entries_prev:
        ...
        if e[0]['label'] > len(labels):
            ...
            label_text = labels[int(e[0]['label'])]
        ...
        iteration += 1
    return frame,location_x,location_y,location_z,label_text
